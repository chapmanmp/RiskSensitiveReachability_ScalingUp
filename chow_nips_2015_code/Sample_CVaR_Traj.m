function [S,A,Y,R,Rtotal] = Sample_CVaR_Traj(MDP,V,Y_set_all,alpha,T,S0,dis)
% Sample a T-step trajectory according to CVaR_alpha policy, from an MDP,
...
for t = 1:T-1
    ...
    xi_vec = xi_cell{A(t)};
    S(t+1) = MDP.sampleNextState(S(t),A(t));
